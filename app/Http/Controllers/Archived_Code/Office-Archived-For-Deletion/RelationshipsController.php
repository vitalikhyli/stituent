<?php
/* NOT SURE THIS CONTROLLER IS NEEDED -- NO RELATIONSHIPS IN OFFICE APP
...
class RelationshipsController extends Controller
{
    ...
    public function searchEntities($v = null)
    {
        ...
        return view(self::$blade.'.relationships.list-entities',compact('entities'));
    }
    ...
    public function searchPeople($v = null)
    {
        ...
        return view(self::$blade.'.relationships.list-people',compact('people'));
    }
    ...
    public function searchKinds($type, $v = null)
    {
        ...
        return view(self::$blade.'.relationships.list-kinds',compact('kinds'));
    }
    ...
    public function delete($id)
    {
        ...
        if ($subject_type == 'p') {
            return redirect(self::$dir.'/constituents/'.$relationship->subject_id);
        }

        if ($subject_type == 'e') {
            return redirect(self::$dir.'/entities/'.$relationship->subject_id);
        }
    ...
    public function update(Request $request, $id, $close = null)
    {
        ...
        if ($close) {
            ...
            return redirect(self::$dir.'/relationships/'.$relationship->id.'/edit');
        }
    }
    ...
    public function save(Request $request, $id, $type)
    {
        ...
        if ($subject_type == 'p') {
            return redirect(self::$dir.'/constituents/'.$id);
        }
        if ($subject_type == 'e') {
            return redirect(self::$dir.'/entities/'.$id);
        }
    ...
    public function edit($id)
    {
        ...
        if ($type == 'p2e') {
            ...
            return view(self::$blade.'.relationships.edit-p2e', compact('person', 'mode','relationship', 'object'));
        }

        if ($type == 'p2p') {
            $person = Person::find($relationship->subject_id);
            $object = Person::find($relationship->object_id);
            return view(self::$blade.'.relationships.edit-p2p', compact('person', 'mode','relationship', 'object'));
        }

        if ($type == 'e2p') {
            $entity = Entity::find($relationship->subject_id);
            $object = Person::find($relationship->object_id);
            return view(self::$blade.'.relationships.edit-e2p', compact('entity', 'mode','relationship', 'object'));
        }

        if ($type == 'e2e') {
            $entity = Entity::find($relationship->subject_id);
            $object = Entity::find($relationship->object_id);
            return view(self::$blade.'.relationships.edit-e2e', compact('entity', 'mode','relationship', 'object'));
        }
    ...
    public function newPersonToPerson($id)
    {
        ...
        $mode = 'save';
        return view(self::$blade.'.relationships.edit-p2p', compact('person', 'mode'));
    }
    ...
    public function newPersonToEntity($id)
    {
        ...
        $mode = 'save';
        return view(self::$blade.'.relationships.edit-p2e', compact('person', 'mode'));
    }
    ...
    public function newEntityToPerson($id)
    {
        ...
        $mode = 'save';
        return view(self::$blade.'.relationships.edit-e2p', compact('entity', 'mode'));
    }
    ...
    public function newEntityToEntity($id)
    {
        ...
        $mode = 'save';
        return view(self::$blade.'.relationships.edit-e2e', compact('entity', 'mode'));
    }
