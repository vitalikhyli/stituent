...
class ListsController extends Controller
{
    ...
    public function view($id)
    {
        ...
        return view('u.lists.result', compact('search', 'output'));
    }
    ...
    public function labelsIndex()
    {
        ...
        return view('u.lists.labels-5160', compact('list_options', 'list_to_use', 'output'));
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('u.lists.main', compact('list_options','list_options_archived'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('u.lists.edit', compact('list', 'terms', 'new_options','new_id'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect('u/search/'.$list->id.'/edit');
    }
    ...
    public function bulkGroupsIndex()
    {
        ...
        return view('u.lists.bulkgroups', compact('list_options', 'list_to_use', 'group_options', 'group_to_use', 'output'));
    }
