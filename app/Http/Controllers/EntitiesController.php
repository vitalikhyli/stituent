...
{
    public function delete($app_type, $entity_id)
    {
        ...
        return redirect('/'.Auth::user()->team->app_type.'/organizations');
    }

    public function unlinkPerson($app_type, $entity_id, $pivot_id)
    {
        $entity = Entity::find($entity_id);
        $this->authorize('basic', $entity);
    ...
    public function linkPerson(Request $request, $app_type, $entity_id)
    {
        ...
        return redirect('/'.Auth::user()->team->app_type.'/organizations/'.$entity->id);
    }

    public function updateRelationship(Request $request, $app_type, $entity_id)
    {
        $person_id = request('relationship_person_id');
        $person = findPersonOrImportVoter($person_id, Auth::user()->team->id);
        $this->authorize('basic', $person);
    ...
    public function deleteRelationship(Request $request, $app_type, $entity_id)
    {
        $person_id = request('relationship_person_id');
        $person = findPersonOrImportVoter($person_id, Auth::user()->team->id);
        $this->authorize('basic', $person);
    ...
    public function addContactToEntity(Request $request, $app_type, $entity_id)
    {
        ...
        return redirect(Auth::user()->team->app_type.'/organizations/'.$theentity->id);
    }

    public function deleteContact(Request $request, $app_type, $model_id, $contact_id)
    {
        //Validation?
        ...
        if (strpos(request()->url(), '/organizations/') !== false) {
            $originated = 'entity';
        }
        ...
        switch ($originated) {
            ...
            case 'entity':
                ...
                $this->authorize('basic', $entity);
                $return_string = Auth::user()->team->app_type.'/organizations/'.$entity->id;
                break;
    ...
    public function updateContact(Request $request, $app_type, $model_id, $contact_id, $close = null)
    {
        //Validation?
    ...
    public function editContact($app_type, $entity, $contact_id)
    {
        ...
        $form_action = '/organizations/'.$entity->id.'/contacts/'.$thecontact->id;
    ...
    public function save(Request $request, $app_type)
    {
        ...
        return redirect(Auth::user()->team->app_type.'/organizations/'.$entity->id.'/edit');
    }
    ...
    public function new($app_type, $v = null)
    {
        ...
        return view('shared-features.entities.new', compact('name'));
    }

    public function search($app_type, $search_value)
    {
        ...
        return view('shared-features.entities.list', compact('entities', 'search_value', 'entity_types'));
    }
    ...
    public function index()
    {
        ...
        return view('shared-features.entities.index', compact('entities', 'entity_types', 'partnerships_count'));
    }
    ...
    public function edit($app_type, $id)
    {
        ...
        return view('shared-features.entities.edit', compact('entity', 'entity_types'));
    }

    public function editType($app_type, $entity_id)
    {
        $entity = Entity::find($entity_id);
        if (request('new_type')) {
        ...
        //dd($app_type, $entity_id);
        $entity->save();

        return redirect()->back();
    }

    public function update(Request $request, $app_type, $id)
    {
    ...
    public function show($app_type, $id)
    {
        ...
        return view('shared-features.entities.show', compact('entity', 'partnership_years', 'common_relationships'));
    }
    ...
    public function partnerships()
    {
        ...
        return view('shared-features.entities.service-learning-partnerships', compact('slps'));
    }
}
