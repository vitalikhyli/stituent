    ...
    <div id="login-left" class="p-8 md:w-7/12" style="">
        ...
        <div class="flex">
            ...
            <div>
                ...
                <div class="text-sm text-grey-dark">
                    Our tools make constituent service as easy as it can be.
                </div>
            </div>
        </div>
        <div class="flex mt-4">
        ...
        <div class="flex mt-4">
            ...
            <div>
                ...
                <div class="text-sm text-grey-dark">
                    Quick access to your data now on your smartphone.
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="">
                ...
                <div class="flex mt-4">
                    <div class="w-full text-center">
                        <button class="w-5/6 bg-blue-500 text-grey-lightest no-underline hover:bg-blue-dark hover:text-white hover:border-white no-underline px-3 py-3 w-full text-sm tracking-wide uppercase" type="submit">
                            Sign In
                        </button>
                    </div>
                </div>
                ...
                <div class="text-center w-full text-sm mt-8">
                    <a class="text-center hover:text-blue-dark text-grey-dark" href="https://calendly.com/communityfluency/60min">
                        {{ __('Schedule Demo') }}
                    </a>
                </div>
            </form>
