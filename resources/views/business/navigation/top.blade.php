<div class="hidden-xs px-10 pb-4 h-48 bg-green-dark" style="">
        ...
        <div class="w-1/5 text-white pt-2">
            ...
            <a href="/{{ Auth::user()->team->app_type }}" class="text-white hover:text-white">
                ...
                <div class="text-2xl mt-6 mb-6 pl-8 relative">
                    ...
                    <span class="ml-2 font-thin tracking-wide">marketing</span><span class="">fluency</span>
...
<!--             <div class="dropdown my-6 w-3/5">
                ...
                <input id="main-lookup-input" type="text" placeholder="Lookup Name, Email, Group, etc" style="font-family:Arial, Font Awesome\ 5 Free" data-toggle="dropdown" autocomplete="off" class="w-full text-green-darkest appearance-none px-6 py-3 bg-green focus:bg-green-lightest shadow-inner" />
...
<div class="hidden-sm hidden-md hidden-lg hidden-xl px-10 pb-4 bg-green h-64" style="">
<!-- <div id="top-bg" class="px-10 pb-4 bg-blue h-48" style="">
 -->
    <div class="mx-auto flex">
