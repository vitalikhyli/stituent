...
@else
	...
	@foreach($people as $theperson)
		...
		@if($theperson->person)
			<tr data-theid="{{ $theperson->id }}" data-thename="{{ $theperson->full_name }}" class="clickable-select-person border-b hover:bg-orange-lighter cursor-pointer bg-orange-lightest">
		...
		@else
			<tr data-theid="{{ $theperson->id }}" data-thename="{{ $theperson->full_name }}" class="clickable-select-person border-b hover:bg-blue-lightest cursor-pointer">
