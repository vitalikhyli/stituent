		...
		<tr class="border-b">
			...
			<td class="p-2 flex">
				...
				<div class="p-1">
					...
					<input data-toggle="tooltip" data-placement="top" title="Instagram" placeholder="Instagram" name="social_instagram" value="{{ $entity->social_instagram }}" class="border px-4 py-2" />
