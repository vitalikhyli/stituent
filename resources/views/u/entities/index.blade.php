...
<div class="flex border-b-4 pb-2 border-blue">
	<div class="text-2xl font-sans w-full">
		<a href="/u/entities/new/" class="float-right text-base text-white rounded-full bg-blue px-4 py-2 hover:text-white hover:bg-blue-dark">
			Add Organization
		</a>
		 <b>{{ $entities->count() }} Organizations</b><span class="text-xl">, {{ $partnerships_count }} Partnerships</span>
	</div>
